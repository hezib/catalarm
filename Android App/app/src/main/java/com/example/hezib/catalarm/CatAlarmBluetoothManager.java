...
/**
 * CatAlarmProximitySensor manages functions related to Bluetoth devices in the
 * AppRTC demo.
 */
public class CatAlarmBluetoothManager {
    private static final String TAG = CatAlarmBluetoothManager.class.getName();
    ...
    private final CatAlarmAudioManager apprtcAudioManager;
     ...
     * Construction.
     */
    static CatAlarmBluetoothManager create(Context context, CatAlarmAudioManager audioManager) {
        Log.d(TAG, "create" + CatAlarmUtils.getThreadInfo());
        return new CatAlarmBluetoothManager(context, audioManager);
    }

    protected CatAlarmBluetoothManager(Context context, CatAlarmAudioManager audioManager) {
        Log.d(TAG, "ctor");
     ...
     * Note that the CatAlarmAudioManager is also involved in driving this state
     * change.
     */
    public void start() {
        ThreadUtils.checkIsOnMainThread();
